...
const interfaceNameList = Object.keys(allInterfaces);
const broadcastAddresses = [];
let addr_info;

function findBroadcastAddress(int = 'en0', address) {
...
function generateBroadcastAddressList() {
  interfaceNameList.forEach(int => {
    broadcastAddresses.push(findBroadcastAddress(int));
  });

  return broadcastAddresses;
}

module.exports = generateBroadcastAddressList;